...
const upload = () => {
  ...
  const isInternshalaUrl = internshalaUrl
    .trim()
    .toLowerCase()
    .includes("internshala.com");
  ...
  const handleInternshalaFetch = async () => {
    ...
    try {
      ...
      let jobDescText = Array.isArray(data.jobDescription)
  ...
  const handleAnalyse = async ({
    ...
    if (!imageFile.file) {
      setIsProcessing(false);
      setStatusText(
        "Failed to convert your resume to image. Please try again."
      );
      return;
    }
    ...
    try {
      ...
      setIsProcessing(false);
      setStatusText(
        "Resume analysed successfully. You can now review your feedback."
      );
      ...
      const prompt = [
        { role: "user", content: [{ type: "text", text: coverLetter }] },
        {
          ...
          content: [
            {
              type: "text",
              text: prepareCoverLetterInstructions({
                jobTitle,
                jobDescription,
              }),
            },
              ...
              <div className="flex flex-row items-center gap-3 mb-4">
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setIsInternshala(e.target.checked)
                  }
              ...
              {isInternshala && (
                <div className="form-div flex flex-col gap-2 mb-4">
                  ...
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                      ...
                      if (
                        ...
                        setInternshalaUrlError(
                          "URL must be from internshala.com"
                        );
                      } else {
                        setInternshalaUrlError("");
                      }
                  ...
                  <button
                    ...
                    disabled={
                      !internshalaUrl || !isInternshalaUrl || isProcessing
                    }
                  >
                    Fetch Job Details
                  </button>
                ...
                <div className="form-div">
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    {rephrasedCoverLetter && (
                      <button
                        type="button"
                        className="bg-white border px-4 py-2 rounded-md cursor-pointer"
                        onClick={() => {
                    ...
                    <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex gap-2 mt-2">
                        <button
                          ...
                          onClick={() => setCoverLetter(rephrasedCoverLetter)}
                        >
                          Use Rephrased
                        </button>
                      </div>
